...
import {Tooltip, Flash, Pill, Field, Table, Pill, Box, Icon, Text, Link, Heading, ToastMessage, Button} from "rimble-ui"
...
<DoDont>
  {{
    ...
    <ul>
      ...
      <li>If the user's wallet/account balance is empty. For example, "your account doesn't have enough funds to use any of our blockchain features"</li>
    </ul>
    </Text>
    ),
    negative: (
    <Text>
    <ul>
<li> Rely on your wallet provider (for example, MetaMask) to explain transaction fees</li>
