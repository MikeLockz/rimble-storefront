              ...
              <Flex mt={6} width={1} flexDirection={["column", "row"]}>
                ...
                <Box flex={"1 1 auto"} width={[1, 1 / 3]} mr={5}>
                  ...
                  >
                    ...
                    <Text.p mt={"1"}>
                      Drop-in components that solve an Ethereum UX problem out
                      of the box. Configure some inputs and you're ready.{" "}
                    </Text.p>
                ...
                <Box flex={"1 1 auto"} width={[1, 1 / 3]}>
                  ...
                  >
                    ...
                    <Text.p mt={"1"}>
                      ...
                      help your users navigate Ethereum.
                    </Text.p>
