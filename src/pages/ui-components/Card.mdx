...
import { Card, Heading, Text, Button, Icon, MetaMaskButton, Image } from 'rimble-ui';


# Card

`Card` renders a responsive box-model layout component. Inherits props from [`Box`](/ui-components/Box) component.
