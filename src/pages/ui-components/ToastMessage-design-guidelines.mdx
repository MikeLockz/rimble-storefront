...
- *Want to build this component?* Read [`ToastMessage`documentation](/Develop/ToastMessage)
- *Want to find out about the provider?* Read [`ToastMessage.provider` documentation](/Develop/ToastMessageProvider)
...
### Use for non-critical informatioon
