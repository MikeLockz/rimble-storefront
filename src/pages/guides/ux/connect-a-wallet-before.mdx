...
<DoDont>
  {{
    positive: (
      <Text>
       Use progressive disclosure if you want to offer more detail – you don't need to go into great detail here, this is just about a heads up, not explaining transaction fees conceptually
      </Text>
    ),
    negative: (
    <Text>
    Assume users know where to get crypto
    </Text>
    ),
  }}
</DoDont>
...
<Button.Outline
  ...
  as="a"
  href="/guides/ux/connect-a-wallet-conditions">Previous part
</Button.Outline>
...
<Button
  ...
  as="a"
  href="/guides/ux/connect-a-wallet-metamask">Next part
</Button>
