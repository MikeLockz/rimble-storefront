  ...
  {{
    positive: (
      <Text>
        <ul>
          ...
          <li>
            Educate them passively – don't force them to learn if they don't
    ...
    negative: (
      <Text>
        <ul>
          <li>
            Ask the user to accept a connection or signature request as soon as
            they land on your dapp
          </li>
          <li>
            Block the user from exploring your dapp until they've connected, if
            you don't need to be connected to browse
          </li>
        </ul>
      </Text>
    )
  ...
  {{
    ...
    negative: (
      <Text>
        <ul>
          <li>
            Just provide a boilerplate "install MetaMask" message as this won't
            work
          </li>
  ...
  {{
    positive: (
      <Text>
        <ul>
          <li>
            Explain that MetaMask is a browser extension that will allow you to
            use the dapp
          </li>
          <li>Provide them a link to download MetaMask</li>
          <li>
            Give them some context as to what features this will unlock in your
            dapp e.g. MetaMask will let you use our blockchain features, like
    ...
    negative: (
      <Text>
        <ul>
          ...
          <li>
            Start explaining MetaMask things like seed phrases here to avoid
            overwhelming the user – that's MetaMask's job
          </li>
        </ul>
      </Text>
    )
    ...
    positive: (
      <Text>
        <ul>
          ...
          <li>
            Tell them where to change it (Desktop: in MetaMask, Mobile: in
            Settings)
          </li>
          <li>
            Be explicit about the above in the title – this is the main
            information they need and users, especially experienced users, are
            likely to just skim the heading
          </li>
          <li>
          ...
          <li>
            Avoid words like "connecting" as this can cause confusion with
            connecting to the dapp – "Set your network to X" or "Switch to X
            network" work better and differentiate this process from connecting
          </li>
        </ul>
      </Text>
    ),
...
<Box p={4} border={1} borderwidth={3} borderColor="primary" mr={2} width={[1/2]}>
<Flex alignItems="center">
<Icon color="primary" mr={3} size="24px" name="ArrowBack" />
<Link
  title="Back to Guides"
...
<Box p={4} border={1} borderwidth={3} borderColor="primary" ml={2} width={[1/2]}>
<Flex alignItems="center" justifyContent="flex-end">
<Link
  title="Read the next part of the guide"
  href="/guides/ux/connect-a-wallet-before"
...
<Flex justifyContent="space-between" mt={3} alignItems="center" flexWrap={'wrap'} alignItems={"stretch"}>
