...
When you want to let the user know that something has been successful. You may want to use a [`ToastMessage`](/ui-components/ToastMessage), but `Flash` is a good option if you want your user to follow up the success with an action.
