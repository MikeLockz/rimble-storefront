    ...
    positive: (
      <Box>
        <Text
          ...
          mb={3}
        >
           Try and avoid having more rows than columns as they're easier to scan.
        </Text>
        <hr color="#f4f4f4"/>
        <Table mt={3}>
          <thead>
    ...
    negative: (
      <Box>
        <Text
          ...
          mb={3}
        >
           The more columns a user has to compare data across the harder it is. Consider other UI.
        </Text>
        <hr color="#f4f4f4"/>
        <Table mt={3}>
          <thead>
    ...
    negative: (
      <Box>
        <Text
          ...
          mb={3}
        >
          Unclear titles make comparing data more difficult for users.
        </Text>
        <hr color="#f4f4f4"/>
        <Table mt={3}>
          <thead>
