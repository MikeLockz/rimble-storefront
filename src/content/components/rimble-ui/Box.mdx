...
title: Box
componentName: Box
description: Box renders a responsive box-model layout component.
...
The `space` function adds margin and padding props. The margin and padding props use a shorthand syntax, similar to [Basscss](http://basscss.com/#basscss-margin), [Tachyons](http://tachyons.io/docs/layout/spacing/), and [Bootstrap](https://getbootstrap.com/docs/4.1/utilities/spacing/).
...
- Arrays can be used for [responsive styles](https://consensys.github.io/rimble-ui/iframe.html?id=components-layout-box--documentation#responsive-styles)
