    ...
    positive: (
      <Box>
        <Text
          ...
          mb={3}
        >
          Use a label to provide instructions for completing the input – not a placeholder.
        </Text>
        <hr color="#f4f4f4" />
        <Field
          mt={3}
    ...
    negative: (
      <Box>
        <Text
          ...
          mb={3}
        >
          Don't use placeholders – they disappear as the user enters the field and makes reviewing form entries difficult as you lose the explanation of the expected input.
        </Text>
        <hr color="#f4f4f4" />
        <Field mt={3}>
          <Input
