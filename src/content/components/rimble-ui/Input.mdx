...
<DoDont>
  {{
    positive: {
      caption: "Use a label to provide instructions for completing the input – not a placeholder.",
      code: (
        <Field
          mt={3}
          label="ENS address"
    ...
    negative: {
      caption: "Don't use placeholders – they disappear as the user enters the field and makes reviewing form entries difficult as you lose the explanation of the expected input.",
      code: (
        <Field mt={3}>
          <Input
            type="text"
