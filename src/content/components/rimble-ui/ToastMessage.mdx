...
_Note: it may be preferable to use alternative components like [`Modal`](/Develop/Modal) to bring a transaction failure to a user's attention, as they can't be missed and provide more space for explanation._
