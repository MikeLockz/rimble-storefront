...
<DoDont>
  {{
    positive: {
      caption: "Keep Blockies square so users have the most detail possible to identify their Ethereum address.",
      code: (
        <Box mt={3}>
          <Blockie
            opts={{
    ...
    negative: {
      caption: "Adding borderRadius makes it more difficult for users to visually identify their Ethereum address.",
        code: (
        <Avatar
          mt={3}
          size="medium"
